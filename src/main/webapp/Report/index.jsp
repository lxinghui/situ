...
function fresh(activity_id,date) {
	location.href = "report/index1?pageno=" + p+"&&activity_id="+activity_id+"&&date="+date;
}
...
function returnobject(o){
	...
	function openuser(){
		layer_show("学生信息","report/add1?activity_id="+activity_id+"&&date="+date,550,350);
	}
	...
	$(function(){
		...
		if(${requestScope.list}!=null){
			...
			for(var i=0;i<j.length;i++){
				$(".ta").append("<tr class='tr' name="+j[i].name+"  info="+j[i].info+"><td>"+j[i].name+"</td><td>"+j[i].info+"</td><td><button  class='del' onclick='del(this);' style='display: inline;' >删除</button></td></tr>");
			}
			}
		}
...
function save() {
		...
		$.post("report/update_json", $(".f1").serialize(), function(json) {
...
<body style="min-width: 300px">
	...
	<form action="report/index1" method="post" style="margin-left: 30px;">
		<div>
	...
	<form class="f1">
		...
		<c:if test="${requestScope.list eq 'null'}">
			<label style="margin-left: 30px;" class="searchtext"><b>教学进度：</b></label>
			<textarea
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;"
				value="">  </textarea>
			<br>
			<label style="margin-left: 30px;" class="searchtext"><b>学生状况：</b></label>
			<textarea
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;"
				value=""> </textarea>
           <br>
			<label style="margin-left: 30px;" class="searchtext"><b>市场状况：</b></label>
			<textarea
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;"
				value=""> </textarea>
				 <br>
		...
		<c:if test="${ requestScope.list != 'null'}">
			<label style="margin-left: 30px;" class="searchtext"><b>教学进度：</b></label>
			<textarea id="my1" type="text" name="tprogress"
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;">
			</textarea>
			<br>
			<label style="margin-left: 30px;" class="searchtext"><b>学生状况：</b></label>
			<textarea id="my2" type="text" name="sprogress"
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;">
</textarea>
           	<br>
			<label style="margin-left: 30px;" class="searchtext"><b>市场状况：</b></label>
			<textarea id="my3" type="text" name="cprogress"
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 22px; border: 1px solid #BABABA;">
</textarea>
 	<br>
			<label style="margin-left: 30px;" class="searchtext"><b>总结：</b></label>
			<textarea id="my4" type="text" name="comments"
				style="width: 400px; height: 90px; margin-top: 5px; margin-left: 46px; border: 1px solid #BABABA;">
</textarea>
		</c:if>
