...
public class Basic_Controller<T> {
	...
	public void index(SearchInfo info, ModelMap m,Integer pageno, HttpServletRequest req) throws Exception {
		if(pageno!=null) {
			info.setPage(pageno);
		}
	...
	@RequestMapping("edit")
	public String edit(Integer id, ModelMap m, HttpServletRequest req) throws Exception {
